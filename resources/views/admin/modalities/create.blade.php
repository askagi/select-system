            ...
            <div class="row">
                ...
                <div class="col-md-11 ml-5">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class=""  action="{{route('dashboard.modalities.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" id="name" placeholder="Insira o nome modalidade" name="name">
