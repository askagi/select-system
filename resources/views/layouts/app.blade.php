...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="index3.html" class="brand-link pt-5 pb-5">
            <img src="{{asset('/storage/assets/boneco-logo.png')}}" alt="Logo" class="brand-image elevation-0" style="width: 20%; ">
            <img src="{{asset('/storage/assets/select.png')}}" alt="Logo" class="img-fluid elevation-0" style="width: 60%;">
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <!-- Student Menu  -->
                    <li class="nav-header p-3">CADASTROS / LISTAGENS</li>
